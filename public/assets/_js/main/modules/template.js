            ...
            if (mode === "init") {
                ...
                if (self._lPage.classList.contains("side-scroll")) {
                    ...
                    if (self._lSidebar && !self._lSidebarScroll) {
                        self._lSidebarScroll = new SimpleBar(
                            self._lSidebarScrollCon
                        );
                    }
                ...
                link.addEventListener("click", (e) => {
                    ...
                    if (
                        ...
                        if (parentLi.classList.contains("open")) {
                            ...
                            Array.from(link.closest("ul").children).forEach(
                                (el) => {
        ...
        let layoutAPI = {
            init: () => {
                ...
                if (self._lPage.classList.contains("enable-page-overlay")) {
                    ...
                    self._lPage.insertBefore(
                        pageOverlay,
                        self._lPage.firstChild
                    );
            ...
            content_layout_toggle: () => {
                if (self._lPage.classList.contains("main-content-boxed")) {
                    ...
                    self._lPage.classList.contains("main-content-narrow")
                ) {
